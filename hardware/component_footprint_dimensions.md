...
| **C4** | 22u | `C_Disc_D5.0mm_W2.5mm_P5.00mm` | `7.10 × 3.00 mm` | 5.00 mm (Span: 5.0×0.0mm) | thru_hole (0.80 mm) | (111.0, 52.0) |
...
| **RADAR1** | C1001_Radar | `C1001_Module` | `20.50 × 20.50 mm` | 2.54 mm (Span: 0.0×12.7mm) | thru_hole (1.00 mm) | (141.5, 112.0) |
...
| **U1** | ESP32_DevKit_V1 | `ESP32_DevKit_DOIT_2x15` | `39.20 × 29.00 mm` | 2.54 mm (Span: 35.6×25.4mm) | thru_hole (1.00 mm) | (132.6, 109.9) |
| **U2** | Digispark_ATtiny85 | `Digispark_9Pin_RightAngle` | `35.00 × 17.00 mm` | 2.54 mm (Span: 12.7×12.7mm) | thru_hole (1.00 mm) | (88.0, 127.0) |
| **U3** | MT3608_Module | `MT3608_Module` | `37.00 × 17.00 mm` | 14.00 mm (Span: 34.0×14.0mm) | thru_hole (1.20 mm) | (72.5, 52.5) |
| **U4** | TP4056_Module | `TP4056_Module` | `17.00 × 27.00 mm` | 2.54 mm (Span: 7.6×0.0mm) | thru_hole (1.00 mm) | (76.0, 106.5) |
...
| **U7** | Buck Converter | `LM2596_Module` | `43.50 × 19.50 mm` | 16.00 mm (Span: 40.0×16.0mm) | thru_hole (1.50 mm) | (68.5, 52.5) |
...
- **Physical Dimensions**: `7.10 mm × 3.00 mm`
- **Placement on PCB**: `X = 111.00 mm`, `Y = 52.00 mm`, Rotation = `-90.0°` (Layer: F.Cu)
- **Total Pads**: 2 (thru_hole)
| Pad # | Local Offset (X, Y) | Pad Size (W × H) | Pad Shape | Hole Drill |
|---|---|---|---|---|
| **1** | `(0.00, 0.00)` | `1.60 × 1.60 mm` | circle | 0.80 mm |
...
- **Placement on PCB**: `X = 140.23 mm`, `Y = 89.00 mm`, Rotation = `0.0°` (Layer: F.Cu)
- **Total Pads**: 2 (thru_hole)
| Pad # | Local Offset (X, Y) | Pad Size (W × H) | Pad Shape | Hole Drill |
|---|---|---|---|---|
...
- **Physical Dimensions**: `9.50 mm × 7.50 mm`
- **Placement on PCB**: `X = 107.25 mm`, `Y = 121.25 mm`, Rotation = `0.0°` (Layer: F.Cu)
- **Total Pads**: 4 (thru_hole)
| Pad # | Local Offset (X, Y) | Pad Size (W × H) | Pad Shape | Hole Drill |
|---|---|---|---|---|
| **1** | `(0.00, 0.00)` | `2.00 × 2.00 mm` | circle | 1.10 mm |
| **1** | `(6.50, 0.00)` | `2.00 × 2.00 mm` | circle | 1.10 mm |
| **2** | `(0.00, 4.50)` | `2.00 × 2.00 mm` | circle | 1.10 mm |
| **2** | `(6.50, 4.50)` | `2.00 × 2.00 mm` | circle | 1.10 mm |
...
- **Placement on PCB**: `X = 132.58 mm`, `Y = 109.86 mm`, Rotation = `180.0°` (Layer: F.Cu)
...
- **Physical Dimensions**: `35.00 mm × 17.00 mm`
- **Placement on PCB**: `X = 88.00 mm`, `Y = 127.00 mm`, Rotation = `180.0°` (Layer: F.Cu)
- **Total Pads**: 9 (thru_hole)
| Pad # | Local Offset (X, Y) | Pad Size (W × H) | Pad Shape | Hole Drill |
|---|---|---|---|---|
| **1** | `(0.00, 12.70)` | `1.70 × 1.70 mm` | rect | 1.00 mm |
| **2** | `(2.54, 12.70)` | `1.70 × 1.70 mm` | circle | 1.00 mm |
| **3** | `(5.08, 12.70)` | `1.70 × 1.70 mm` | circle | 1.00 mm |
| **4** | `(7.62, 12.70)` | `1.70 × 1.70 mm` | circle | 1.00 mm |
| **5** | `(10.16, 12.70)` | `1.70 × 1.70 mm` | circle | 1.00 mm |
| **6** | `(12.70, 12.70)` | `1.70 × 1.70 mm` | circle | 1.00 mm |
| **7** | `(0.00, 5.08)` | `1.70 × 1.70 mm` | circle | 1.00 mm |
| **8** | `(0.00, 2.54)` | `1.70 × 1.70 mm` | circle | 1.00 mm |
| **9** | `(0.00, 0.00)` | `1.70 × 1.70 mm` | rect | 1.00 mm |

### `U3` - MT3608_Module (`FallSensor:MT3608_Module`)
- **Physical Dimensions**: `37.00 mm × 17.00 mm`
- **Placement on PCB**: `X = 72.50 mm`, `Y = 52.50 mm`, Rotation = `0.0°` (Layer: F.Cu)
- **Total Pads**: 4 (thru_hole)
| Pad # | Local Offset (X, Y) | Pad Size (W × H) | Pad Shape | Hole Drill |
|---|---|---|---|---|
| **1** | `(0.00, 14.00)` | `2.00 × 2.00 mm` | rect | 1.20 mm |
| **2** | `(0.00, 0.00)` | `2.00 × 2.00 mm` | circle | 1.20 mm |
| **3** | `(34.00, 14.00)` | `2.00 × 2.00 mm` | circle | 1.20 mm |
| **4** | `(34.00, 0.00)` | `2.00 × 2.00 mm` | circle | 1.20 mm |

### `U4` - TP4056_Module (`FallSensor:TP4056_Module`)
- **Physical Dimensions**: `17.00 mm × 27.00 mm`
- **Placement on PCB**: `X = 76.00 mm`, `Y = 106.50 mm`, Rotation = `90.0°` (Layer: F.Cu)
- **Total Pads**: 4 (thru_hole)
| Pad # | Local Offset (X, Y) | Pad Size (W × H) | Pad Shape | Hole Drill |
|---|---|---|---|---|
| **1** | `(2.54, 0.00)` | `1.70 × 1.70 mm` | circle | 1.00 mm |
| **2** | `(5.08, 0.00)` | `1.70 × 1.70 mm` | circle | 1.00 mm |
| **3** | `(0.00, 0.00)` | `1.70 × 1.70 mm` | rect | 1.00 mm |
| **4** | `(7.62, 0.00)` | `1.70 × 1.70 mm` | circle | 1.00 mm |

### `U5` - LM393_Sound_Module (`FallSensor:LM393_Sound_Module`)
- **Physical Dimensions**: `16.62 mm × 37.00 mm`
...
| Pad # | Local Offset (X, Y) | Pad Size (W × H) | Pad Shape | Hole Drill |
|---|---|---|---|---|
| **1** | `(0.00, 0.00)` | `3.00 × 3.00 mm` | rect | 1.50 mm |
| **2** | `(0.00, 16.00)` | `3.00 × 3.00 mm` | circle | 1.50 mm |
| **3** | `(40.00, 0.00)` | `3.00 × 3.00 mm` | circle | 1.50 mm |
| **4** | `(40.00, 16.00)` | `3.00 × 3.00 mm` | circle | 1.50 mm |
